...
class Pipe:
    ...
    def get_headers(self) -> Dict[str, str]:
        ...
        # Use Basic Auth credentials (admin, password)
            ...
            try:
                ...
                async with session.post(
                    ...
                    if response.status == 200:
                        ...
                        if response_data is None or self.valves.RESPONSE_FIELD not in response_data:
                            raise Exception(f"N8N response is missing the expected field '{self.valves.RESPONSE_FIELD}'. Response: {response_data}")
